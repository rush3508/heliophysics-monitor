...
[![Ollama](https://img.shields.io/badge/LLM-llama3.2-green.svg)](https://ollama.com)
...
4. **Generates** a 150–250 word analyst brief using llama3.2 (3B, local Ollama)
   with retrieval grounding, token budget enforcement, and hallucination guards

5. **Publishes** a standalone static HTML dashboard (6 D3.js panels, dark theme)
...
| LLM | llama3.2 (3B Q4_K_M) via Ollama, context_window=4096 |
| Dashboard | D3.js + Jinja2, standalone HTML, CDN d3.js v7 |
...
│   └── reporting/
│       ├── generate_brief.py   # llama3.2 analyst brief
│       └── solar_disc.py       # CME solar disc projection
│       ├── build_dashboard.py  # D3.js static HTML dashboard
├── data/
